...
!!! note "译注"
    本节中所有与示例项目相关的内容将默认折叠，以便阅读  

    因为，进行开发的时候，推荐使用 discord.js 或者 discord.py 这样的社区库。它们封装了操作，让开发变得更加简单。
...
## [步骤 2：运行您的应用](https://discord.com/developers/docs/quick-start/getting-started#step-2-running-your-app) 
